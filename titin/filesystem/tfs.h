...
#define TFS_DATA_SIZE 1024
#define TFS_PATH_SIZE 256

#define TFS_STORAGE_SECTOR_SIZE 512
#define TFS_STORAGE_RECORD_SIZE 1088
#define TFS_STORAGE_SIZE \
    (TFS_OBJECT_LIMIT * TFS_STORAGE_RECORD_SIZE)
#define TFS_STORAGE_SECTOR_COUNT 272
